...
1. References
    ...
    6. [Remote Spark Jobs on YARN](https://theckang.github.io/2015/12/31/remote-spark-jobs-on-yarn.html)
2. Java
    1. Envs
...
8. Spark
    ...
    4. Services
        ...
        2. spark on yarn
            ...
            2. when submit locally, config client `HADOOP_CONF_DIR`, which should include `core-site.xml` and `yarn-site.xml` copied from the hadoop cluster
        3. Problems
    ...
    5. Access
        1. spark standalone cluster
            ...
            2. `http://hpmaster:8080`: master info
            3. `http://hpslave:8081`: workder info
            4. `http://hpmaster:4040`: driver application info
    6. Commands
