...
5. Kafka
    ...
    4. Services
        ...
        4. connectors
            1. standalone
                1. start: `connect-standalone.sh <config/connect-standalone.properties> <connector1.properties> [<connector2.properties>...]`
            2. cluster
                1. start: `connect-distributed.sh [-daemon] <config/connect-distributed.properties>`
                2. list connectors: `curl -X GET -H 'Content-Type: application/json' -i 'http://hpmaster:8083/connectors`
        5. jps: `kafka`
    5. Commands
