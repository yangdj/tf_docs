...
8. Hbase
    ...
    6. Commands
        1. Table
            1. create table: `create "<table_name>", "<column_family>"`
            2. confirm table: `list "<table_name>"`
            3. detail: `describe "<table_name>"`
            4. disable table before deleting or changing its settings: `disable "<table_name>"`
            5. enable table: `enable "<table_name>"`
            6. drop table: `drop "<table_name>"`
            7. put data: `put "<table_name>", "<row1>", "column_family:a", "value1"`
            8. get data: `get "<table_name>", "<row1>"`
            9. scan all data: `scan "<table_name>"`
9. Scala
    1. Install
        ...
        3. `spark-submit`
            ...
            2. arguments
                1. `--master`
                    ...
                    4. `local[*]`
                    5. `spark://host:port`
                    6. `spark://host1:port1,host2:port2`
                    7. `mesos://host:7077`
                    8. `k8s://xx.yy.zz.ww:443`
