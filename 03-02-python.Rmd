...
3. Concepts
    ...
    5. Modules: the units of code ansible executes, since ansible 2.10, modules are grouped in collections
        ...
        11. `ansible.builtin.setup`: get raw system information, `ansible <hostname> -m ansible.builtin.setup`
        ...
        1. Keywords
            ...
            12. `tasks`: the units of an action in ansible, can be executed once with an ad hoc command
                1. Keywords
                    ...
                    2. `become: yes`
                    3. `the_module_name`
                    4. `register`: register a variable from the output of the task
                    5. `notify`
                    ...
                    9. `loop`
                    10. `until`
                    11. `retries: 5`: default 3, `until` must be defined, if not, `retries` is forced to 1
                    12. `delay: 10`: seconds, default is 5
            13. `handlers`
