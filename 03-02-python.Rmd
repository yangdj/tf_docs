...
1. builtins
    ...
    13. `zip(a, b)`: `dict(zip(a,b))` returns a dict from a and b
...
12. string: a collection of string constants
...
13. Generator
    ...
    2. generator expressions: use `()` similar to list comprehension
...
* str
    ...
    4.  Operations
        ...
        11. `.zfill(width)`: pad a numeric string with zeros on the left, the string is never truncated
        12. `.format(*args, **kwargs)`
...
References: [python3_decorators](https://www.python-course.eu/python3_decorators.php)
