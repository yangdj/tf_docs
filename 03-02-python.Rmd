...
```sh
nohup airflow webserver >> /data/jst/airflow/server_logs/webserver.log &
nohup airflow worker >> /data/jst/airflow/server_logs/worker.log &
nohup airflow scheduler >> /data/jst/airflow/server_logs/scheduler.log &
nohup airflow flower >> /data/jst/airflow/server_logs/flower.log &
```
