...
5. `.`: any character
6. `[]`
    1. `[...]`: include any character in it, `[1234abcd]`
    2. `[^...]`: exclude any character in it, [^0-9]
...
14. POSIX Classes
    ...
    8. `[[:blank:]]`: SPACE and TAB and locale blank characters
    ...
    14. `\d`, `\D`: `[[:digit:]]`, `[^[[:digit:]]]`
    15. `\s`, `\S`: `[[:space:]]`, `[^[[]:space:]]]`
    16. `\<`, `\>`: empty character at the start and end of a word
    17. `\b`, `\B`: be or not to be empty character at either end of a word
