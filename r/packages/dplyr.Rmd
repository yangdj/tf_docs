...
* [advanced R book solutions](https://bookdown.org/Tazinho/Advanced-R-Solutions/)
* [advanced R solutions](https://github.com/peterhurford/adv-r-book-solutions)
* [Non standard evaluation from another function in R
](https://stackoverflow.com/questions/30563745/non-standard-evaluation-from-another-function-in-r)
...
* `slice()`: select row by position, `slice(data, 1:12)`
