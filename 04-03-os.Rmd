...
1. References
    ...
    2. [Command-line syntax key](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/command-line-syntax-key)
    ...
    1. elements
        ...
        3. options
            1. short: start with `-`
                ...
                3. `-abc`: use stacked way, equivalent to `-a -b -c`
