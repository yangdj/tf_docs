...
* MariaDB/MySQL
    * Linux
        ...
        ```
    * [Windows](https://dev.mysql.com/downloads/connector/odbc/)
...
* [Impala](https://www.cloudera.com/downloads/connectors/impala/odbc/2-6-5.html)
    * Windows: `DSN -> Advanced Options -> Use SQL Unicode Types`
