    ...
    5. other related
        ...
        4. bookdown
            1. compile
                ...
                6. `rmarkdown::render_site(encoding = 'UTF-8')`: render project
            2. structure
                1. `bookname/`
                    1. `_bookdown.yml`

                        ```yaml
                        book_filename: "book_name" # filename of the main Rmd file (e.g., merged from all chapters),  _main.Rmd default
                        language:
                          label:
                            fig: 'Figure '
                            tab: 'Table '
