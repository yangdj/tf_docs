...
1. References
    ...
    4. [Java Concurrency](http://tutorials.jenkov.com/java-concurrency/volatile.html)
    5. [Singleton](https://en.wikipedia.org/wiki/Singleton_pattern#Lazy_initialization)
2. Command
    1. Common
        1. `jar`
