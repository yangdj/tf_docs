...
8. Class
    ...
    2. Modifiers
        ...
        7. `this(n: Int) = this(n, 1)`: auxiliary constructor must invoke another constructor of the same class first. the     primary construction is the fisingle point of entry of a class, and the only calls supclass constructor
    3. Definition
        1. Regular
