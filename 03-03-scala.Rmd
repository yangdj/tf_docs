    ...
    1. System
        ...
        2. `System.out`
            ...
            2. `.format()`: specifiers begin with `%`
                ...
                6. `%%`: output `%`
        3. `System.err`: similar to `System.out`
    2. Utils
        ...
        3. `java.util.Scanner`: use while space to separate tokens, including blanks, tabs and line terminators
            1. `.useDelimiter(",\\s*")`
