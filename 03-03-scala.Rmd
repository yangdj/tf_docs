...
1. References
    ...
    7. [How to Stop a Thread or a Task](http://forward.com.au/javaProgramming/HowToStopAThread.html)
    8. [Why Are Thread.stop, Thread.suspend, Thread.resume and Runtime.runFinalizersOnExit Deprecated?](https://docs.oracle.com/javase/1.5.0/docs/guide/misc/threadPrimitiveDeprecation.html)
2. Command
    1. Common
        1. `jar`
