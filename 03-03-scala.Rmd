    ...
    1. Java
        1. Variables
            ...
            3. Array: hold a fix number of values of a single type
                ...
                4. creation: `anArray = new int[10]`
                5. initialization: `anArray[0] = 100`
                6. access: `anArray[0]`
                7. creation and initialization: `int[] anArray = {100, 200, ..., 1000}`, length is determined by element number in the brace separated by commas
...
4. Class and Objects
    1. Java
        ...
        4. Nested Class: classes defined within another class
            1. Type
                1. static nested class
                    1. declared with `static`
                    2. a member of its enclosing class, can not access to other members of the enclosing class
                ...
                2. inner class
                    ...
                    ```
        5. Subclass: use `extends` to extend its superclass, a class can only extend one parent
        6. Interface: use `implements` to imlement interface, multiple interfaces can be implements separated by commas
        7. Object
            1. `null`
