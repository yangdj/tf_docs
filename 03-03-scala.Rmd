        ...
        1.  Modifier
            ...
            2. Value
                ...
                2. `final`: value can not be changed
                    ...
                    2. method: can not be ovririded
                    3. variable: value can not be change
        2. Class
            1. Member
                1. Variable
                    1. Instance Variable: fields, non-static fields, unique to each instance of class
                        1. uninitialized default value
                            1. primitive: see primitive data types
                            2. objects: `null`
                    2. Class Variable: static fields, declared with `static` modifier, only one copy of this variable
                2. Method
                    ...
                    2. Arguments: actual values passed to the invoked method. When pass an arbitary number of values to a method, use varargs following the type of last parameter by an ellipsis (three dots, `...`), then a space and the paremeter name and the parameter is treated as an array
                        ...
                        ```
                    3. Return Type: value returned by the method, or `void` if the method does not return a value
                ...
                3. Constructor: create objects from the class blueprint, like method declarations
                    ...
                    3. the compiler automatically provide a no-argument, default constructor for any class without constructors. This default constructor will call the no-argument constructor of the superclass. The compiler will complain if the superclass doesnot have a no-argument constructor. If class has no explicit superclass, then it has an implicit superclass of `Object`, which does have a no-argument constructor
        3. Subclass: use `extends` to extend its superclass, a class can only extend one parent
        4. Interface: use `implements` to imlement interface, multiple interfaces can be implements separated by commas
        5. Object
            1. `null`
