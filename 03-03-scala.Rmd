        ...
        3. Nested Class
            ...
            2. defined within method: access modifiers apply
                ...
                2. anonymous
                    ...
                    1. make code more concise if only use only once
                    2. is an expression, enable to declare and instantiate a class at the same time
                    3. cannot declare constructors
                3. lambda expression
                    ...
                    ```
        4. Subclass: use `extends` to extend its superclass, a class can only extend one parent
        5. Interface: use `implements` to imlement interface, multiple interfaces can be implements separated by commas
        6. Object
            1. `null`
