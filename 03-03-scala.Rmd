    ...
    1. Java
        1.  Modifier
            ...
            2. Others
                ...
                2. `final`: value can not be changed
                    ...
                    2. method: can not be overrided
                    3. variable: value can not be change
        ...
        4. Inheritance and SubClass
            ...
            2. Members
                ...
                4. declare fields with the same name as the ones in the superclass, thus **hiding them, not recommended**
                ...
                7. write new *static* methods have the same signature as the ones in the superclass, thus **hiding them**
                8. write new methods not in the superclass
                9. write subclass constructors that invoke superclass's constructor using keyword `super`
            3. Operations
